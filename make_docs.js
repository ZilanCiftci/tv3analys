...
const handledning = doc("Användarhandledning – tv3_analys", "Analys av TV-inspektioner av avloppsledningar från TV3-filer", [
  ...
  p("Sökvägarna pekar på mappen där `kartunderlag.json` låg när lagret skapades (`rapporter\\…` bredvid den). Flyttar du utdatamappen, kör verktyget igen så räknas sökvägarna om."),
  h2("7.4 Sträckor som inte hittas"),
