...
const handledning = doc("Användarhandledning – tv3_analys", "Analys av TV-inspektioner av avloppsledningar från TV3-filer", [
  ...
  p("Klassfärgerna är desamma som i Excel och diagrammen: rött A, orange B, gult C, grönt D, grått E. Spara sedan lagret som `.lyr` (högerklicka på lagret > Save As Layer File) och ange filen i verktygets fält Symbologi, eller i `LYR_FIL` i skriptet; nästa körning applicerar symbologin automatiskt."),
