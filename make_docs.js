...
const handledning = doc("Användarhandledning – tv3_analys", "Analys av TV-inspektioner av avloppsledningar från TV3-filer", [
  ...
  p("Enklast är verktyget **Skapa symbologi (.lyr)**: välj ledningslagret i kartan och var `.lyr`-filen ska sparas. Verktyget bygger renderaren, sätter den på lagret och sparar filen. Det använder Python-paketet `comtypes`, som följer med i mappen `arcmap/lib` – ingen installation behövs. Första körningen tar en stund eftersom comtypes genererar kod för ArcObjects; därefter går det på några sekunder."),
